...
In order to study the reflection and transmission of an electromagnetic plane wave illuminating an arbitrary thin film located at $z=0$, it is proposed the decomposition of the electric $\vb{E}(\vb{r})$ and magnetic $\vb{B}(\vb{r})$, as well as $\vb{D}(\vb{r}) = \varepsilon(\vb{r})\vb{E}(\vb{r})$  and $\vb{H}(\vb{r}) = \mu^{-1}(\vb{r})\vb{B}(\vb{r})$, above, below and on the thin film as follows
%
\begin{align}
