...
\begin{frame}[t]{Antecedentes}
	...
	\begin{beamercolorbox}[wd=1.3\squeezethree]{}
		\emphr{Metasuperficie plasmónica:} Arreglo bidimensional de nanoestructuras metálicas
	...
	\begin{textblock*}{1mm}(140mm,10mm)
		\begin{tikzpicture}[font=\scriptsize]
			\node (img) {\includegraphics[width = 85mm]{img/0-Intro/kabashin-1.png}};
			\path (img.200) node [anchor = east, xshift= 0mm] {\begin{minipage}{40mm}
					...
					\end{flushright}
			\end{minipage}};	
			\path (img.135) node[anchor = north west, xshift = -2mm]{\includegraphics[width = 35mm]{img/0-Intro/kabashin-2.png}};
		\end{tikzpicture}
	\end{textblock*}
	...
	\begin{textblock*}{1mm}(40mm,90mm)
		\begin{tikzpicture}[font=\scriptsize]
			\node (img) {\includegraphics[width = 85mm]{img/0-Intro/qiu-1.png}};
	...
	\begin{textblock*}{1mm}(140mm,80mm)
		\begin{tikzpicture}[font=\scriptsize]
			\node (img) {\includegraphics[width = 85mm]{img/0-Intro/qiu-2.png}};
...
\begin{frame}[c]{\underline{Metasuperficies en condiciones realistas}}
	...
	% Wang Polidispersidad -----------------------------------------
		\node[below=of poli] (wang) {\includegraphics[width = 80mm]{img/0-Intro/wang.png}};
	...
	% Bohra Sustrato -----------------------------------------				
		\node[below=of sus, xshift=-7.5mm] (borah) {\includegraphics[width = 80mm]{img/0-Intro/borah.png}};
	...
	% Moirangthem Incrustación -----------------------------------------	
		\node[below=of emb] (mori) {\includegraphics[width = 80mm]{img/0-Intro/moirangthem.png}};
...
\begin{columns}
	...
	\begin{block}{\centering  Teorías de medio efectivo\footnotemark[1]}
		\vskip1em
		\begin{itemize}
			\item Remplazo de medio heterogéneo por \emphr{homogéneo}
...
\begin{frame}{Objetivos}
		...
		\begin{tikzpicture}[node distance=20mm and 30mm,font=\normalfont]
			...
			\node[flowbox] (general) {%
				...
				\begin{minipage}{.35\textwidth}
					Identificar teóricamente \emphr{efectos de sustrato} y \emphb{esparcimiento múltiple} en \textbf{metasuperficies plasmónicas desordenadas} y contrastar con \textbf{datos experimentales}.
				\end{minipage}
			};
			...
			\node[flowbox,below=of part] (efects) {%
				...
				Caracterización de metasuperficie sintetizada en INAOE
					\begin{itemize}\itemsep0em  \small
						\item \emphr{Incrustación parcial}
			...
			\node[flowbox,below right=of part] (dis) {%
				...
				\nodepart{two}
				\begin{minipage}{.24\textwidth}
				Metasuperficie enfocada en biosensado
					\begin{itemize}\itemsep0em  \small
						\item Dos morfologías (CSM y TFT)
						\item Esquema de medición de fase
						\item \emphb{Corrimiento hacia el azul}
					\end{itemize}
				\end{minipage}
			};
	...
	\begin{textblock*}{1mm}(200mm,10mm)
		\begin{tikzpicture}[font=\normalfont]
			\node (img) {\includegraphics[width = 50mm]{img/0-Intro/colab.png}};
