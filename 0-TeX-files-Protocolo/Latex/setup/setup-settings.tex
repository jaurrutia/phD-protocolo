...
\tikzset{%
    ...
    conn/.style={draw=jdblue, -{Latex[length=3mm]},
                 rounded corners=3pt},
    conng/.style={draw=tumdarkgreen, -{Latex[length=3mm]},
                 rounded corners=3pt},
...
\newcommand{\emphg}[1]{\textcolor{jdgreen}{\textbf{#1}}}
% \setbeamercolor{emph}{fg=jdgreen}
% \renewcommand<>{\emph}[1]{%
%   {\usebeamercolor[fg]{emph}\only#2{\bf}#1}%
% }
