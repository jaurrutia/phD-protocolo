...
\svgpath{{2-mainmatter/2-Theory/figs},{3-Apendices/figs},{2-mainmatter/3-Results/figs}}
\graphicspath{{3-Apendices/figs},{2-mainmatter/1-Introduccion/figs}}
...
%\include{1-frontmatter/1-Acknowledgments}
%\include{1-frontmatter/2-Declaration}
%\include{1-frontmatter/3-Quote}
%\include{1-frontmatter/4-Abstract}
...
\input{2-mainmatter/1-Introduccion/1-Motivation-Structure}
...
\chapter{Scattering Theory of a Single Spherical Particle}
  \label{ch:OpticalProperties}
	...
	\section{The Optical Theorem: Amplitude Matrix and Cross Sections}
	 ...
	 \input{2-mainmatter/2-Theory/1-OpticalTheorem}
...
\chapter{Results and Discussion}
    ...
    \section{Supported and Totally Embedded Spherical Particles}
     \label{s:Totally}
        \input{2-mainmatter/3-Results/0-Intro}

        \subsection{Normal Incidence}
        \input{2-mainmatter/3-Results/1-Totally}
...
\addcontentsline{toc}{chapter}{\protect\numberline{}Conclusions}
	...
	\input{2-mainmatter/4-Conclusions/1-Conclusions}	
...
\chapter{Mie Theory (Conventions)}
  \label{app:MieCode}
  \input{3-Apendices/1-SpecialFunc}
